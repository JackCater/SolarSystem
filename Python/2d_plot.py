...
class plot_traj:
    def __init__(self, filename, xlim=0, ylim=0, rotate=False, tail=True, labels=False, show_anim=True,
                 axes=True, axes_text=True, rotate_speed=5):
        # define variables
        ...
        self.axes_text, self.rotate_speed = axes_text, rotate_speed
...
if __name__ == "__main__":
    planets = plot_traj("rkf4_test.csv", rotate=False, show_anim=True)
